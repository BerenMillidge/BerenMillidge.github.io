...
layout: page
title: Sequences
subtitle: Curated paths through my blog
permalink: /sequences/
---
...
1. [The AI AI Safety Problem]({% post_url 2020-09-07-The-AI-AI-safety-problem %})
2. [The Ultimate Limits of Alignment Determine the Shape of the Long Term Future]({% post_url 2022-08-16-Ultimate-limits-alignment %})
3. [Deconfusing Direct vs Amortized Optimization]({% post_url 2022-09-25-Deconfusing-direct-vs-amortized-optimization %})
4. [Orthogonality Is Expensive]({% post_url 2023-03-19-Orthogonality-is-expensive %})
5. [Preference Aggregation as Bayesian Inference]({% post_url 2023-07-13-Preference-Aggregation-as-Bayesian-Inference %})
6. [Understanding Functional Decision Theory as Program Search]({% post_url 2026-06-30-Understanding-Functional-Decision-Theory-as-Program-Search %})
...
1. [Against Ubiquitous Alignment Taxes]({% post_url 2023-03-05-against-ubiquitous-alignment-taxes %})
2. [The Case for Removing Alignment and ML Research from the Training Data]({% post_url 2023-05-28-The-case-for-removing-AI-alignment-and-ML-from-the-training-dataset %})
...
6. [Math Capabilities could be Differentially Good for Alignment]({% post_url 2026-09-06-Math-Capabilities-Could-Be-Differentially-Good-For-Alignment %})
7. [Many Benefits of AGI Could Still be Realized in a Pause]({% post_url 2026-09-08-Many-Benefits-of-AGI-Could-Still-Be-Realized-In-A-Pause %})
8. [Algorithmic Progress is not Exogenous]({% post_url 2026-09-16-Algorithmic-Progress-is-not-Exogenous %})
...
1. [Reflections on the Bitter Lesson]({% post_url 2020-07-13-Reflections-On-The-Bitter-Lesson %})
...
1. [Deep Learning Models Are Secretly (Almost) Linear]({% post_url 2023-04-04-DL-models-are-secretly-linear %})
2. [Learning Linear Representations through Implicit Subspace Selection]({% post_url 2023-12-29-learning-linear-representations-through-implicit-subspace-selection %})
...
3. [The Unconditioned Distribution of Current Open LLMs]({% post_url 2024-05-12-The-Unconditioned-Distribution-of-Current-Open-LLMs %})
4. [Scaffolded LLMs as Natural-Language Computers]({% post_url 2023-04-11-Scaffolded-LLMs-natural-language-computers %})
5. [Does Scaffolding Help Humans?]({% post_url 2024-05-05-Does-Scaffolding-Help-Humans %})
...
3. [Clarifying Value Alignment in Predictive Processing]({% post_url 2022-01-05-Clarifying-Value-Alignment-in-Predictive-Processing %})
4. [Thoughts on the Future of Predictive Coding]({% post_url 2023-03-30-Thoughts-on-future-of-PC %})
5. [Predictive Coding Networks Can Perform Causal and Counterfactual Inference]({% post_url 2023-04-14-Predictive-coding-networks-can-perform-causal-and-counterfactual-inference %})
6. [A Retrospective on Active Inference]({% post_url 2024-07-27-A-Retrospective-on-Active-Inference %})
...
1. [Intellectual Progress in 2019]({% post_url 2020-01-20-Intellectual-Progress-In-2019 %})
2. [Intellectual Progress in 2020]({% post_url 2021-02-08-Intellectual-Progress-2020 %})
3. [Intellectual Progress in 2021]({% post_url 2022-09-24-Intellectual-progress-in-2021 %})
4. [My PhD Experience]({% post_url 2023-04-09-My-PhD-experience %})
5. [Intellectual Progress in 2022]({% post_url 2023-02-13-Intellectual-progress-in-2022 %})
6. [Intellectual Progress in 2023]({% post_url 2023-12-26-Intellectual-Progress-in-2023 %})
7. [Intellectual Progress in 2024]({% post_url 2025-01-04-Intellectual-Progress-in-2024 %})
8. [Intellectual Progress in 2025]({% post_url 2026-01-01-Intellectual-Progress-in-2025 %})
